...
public class DungeonDoor extends SectionDoor {
    ...
    public String name;
    public int nLX,nLY;
    public DungeonDoor(int x, int y, int width, int height, Direction direction,String name, Handler handler,int newLinkX,int newLinkY) {
        super(x, y,width,height,direction, handler);
        this.width = width;
        this.height = height;
