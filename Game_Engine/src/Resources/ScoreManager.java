...
public class ScoreManager {
    ...
    private int mspacmanCurrentScore=0;
    ...
    public int getMspacmanCurrentScore() {
		return mspacmanCurrentScore;
	}

	public void setMspacmanCurrentScore(int mspacmanCurrentScore) {
		this.mspacmanCurrentScore = mspacmanCurrentScore;
	}
    
	public void addMsPacmanCurrentScore(int mspacmanCurrentScore) {
        this.mspacmanCurrentScore += mspacmanCurrentScore;
    }

    public void removeMsPacmanCurrentScore(int mspacmanCurrentScore) {
        this.mspacmanCurrentScore -= mspacmanCurrentScore;
    }
